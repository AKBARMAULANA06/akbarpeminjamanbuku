...
<div class="container-fluid px-4 py-4" style="background: #faf7f2; min-height: 100vh;">
    ...
    <div class="card border-0" style="border-radius: 32px; background: white; box-shadow: 0 20px 40px -15px rgba(100, 70, 40, 0.2); overflow: hidden;">
        ...
        <div class="card-body p-4">
            <form action="{{ route('admin.alat.store') }}" method="POST" enctype="multipart/form-data" id="formTambahBuku">
                @csrf
                ...
                <div class="d-flex gap-3 justify-content-end">
                    ...
                    <button type="submit" class="btn px-5 py-3" id="btnSubmit" style="background: linear-gradient(135deg, #8b5a2b 0%, #a8753a 100%); color: white; border-radius: 16px; font-weight: 600; border: none; box-shadow: 0 10px 20px -5px rgba(139, 90, 43, 0.3);">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Preview jika ada file yang sudah dipilih sebelumnya
    @if(old('foto'))
        const fileInfo = document.createElement('div');
        fileInfo.className = 'alert alert-info mt-2';
        fileInfo.innerHTML = '<i class="bi bi-info-circle me-2"></i>File cover sudah dipilih. Silakan pilih ulang jika ingin mengganti.';
        fotoInput.parentNode.appendChild(fileInfo);
    @endif
